              ...
              itemBuilder: (context, index) {
                return Padding(
                  ...
                  child: GestureDetector(
                    onTap: () {
                      // print("****************USERMODEL*******************${homeScreenController.userModel.value.title?.length}");
                    },
                    child: Container(
                      child: Center(
                          child: Padding(
          ...
          Expanded(
            child: Obx(
              () => Container(
                child: ListView.builder(
                    shrinkWrap: true,
                    itemCount: editScreenController.userList.value.length,
                    physics: BouncingScrollPhysics(),
                          ...
                          () => GestureDetector(
                            onTap: (){
                              Get.toNamed(AppRouter.editscanScreen,
                                arguments: [editScreenController.userList.value[index]]
                              );
                              print("##############index########${index}");
                            },
                            child: Container(
                                    ...
                                    Container(
                                      ...
                                      child: Image.asset(
                                        editScreenController
                                                .userList.value[index].logo
                                                .toString() ??
                                            "",
                                        // homeScreenController.userModel.value.logo.toString()??"",
                                        width: 60,
                                        height: 60,
                                      ),
                                      decoration: BoxDecoration(
