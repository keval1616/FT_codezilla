...
class EditscanScreen extends StatefulWidget {
  ...
  EditscanScreen({Key? key, details, indexOfpass}) : super(key: key);
...
class _EditscanScreenState extends State<EditscanScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      setState(() {
        if (Get.arguments[2] == EnumForButton.homescreen) {
          UserModel userModel =
              Get.arguments != null ? Get.arguments[0] : UserModel();
          argumentOfIndex = Get.arguments[1] != null ? Get.arguments[1] : 0;
